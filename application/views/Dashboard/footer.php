...
<div class="container my-auto">
    <div class="copyright text-center my-auto">
        <span>Copyright &copy; Person's Reborn 2020</span>
    </div>
</div>
</footer>
<!-- End of Footer -->
...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">Mau kemana?:(</h5>
    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">×</span>
    </button>
</div>
<div class="modal-body">Pilih "Logout" nek meh bener-bener keluar</div>
